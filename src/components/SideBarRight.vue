<template>
    <v-navigation-drawer app color="grey lighten-3" right width="280">
        ...
        <v-app-bar flat color="rgba(0,0,0,0)" class="mt-n5">
            ...
            <h5 class="ml-2 grey--text text--darken-2">
                Dial me for order spesification
            </h5>
        </v-app-bar>
        <v-divider></v-divider>
        <v-container>
            <v-row>
                ...
                <v-col cols="12" sm="3">
                    <h6 class="ml-n6 grey--text text--darken-2">
                        Bean Soup <br />
                        <span class="grey--text text--lighten-1">359g</span>
                    </h6>
                </v-col>
                <v-col cols="12" sm="6">
                    <v-chip
        ...
        <div class="text-center">
            <v-btn color="green" class="px-15" rounded dark> Checkout </v-btn>
        </div>
        <div class="text-center">
            <v-card elevation="2" class="mt-2 mx-2 pa-3">
                <v-container>
                    <v-row>
                        <v-col cols="12" sm="2">
                            <v-icon color="blue" class="ml-n2">
                                fab fa-cc-visa
                            </v-icon>
                        </v-col>
                        <v-col cols="12" sm="2">
                            <span class="caption text-9xl ml-n3">****</span>
                        </v-col>
                        <v-col cols="12" sm="2">
                            <span class="caption text-9xl ml-n5">****</span>
                        </v-col>
                        <v-col cols="12" sm="2">
                            <span class="caption text-9xl ml-n5">****</span>
                        </v-col>
                        <v-col cols="12" sm="2">
                            <span class="caption text-9xl ml-n5">6132</span>
                        </v-col>
                        <v-col cols="12" sm="2">
